package rocks.sakira.sakurarosea.common.entities.models;
...
public class SakuraBoatModel extends SegmentedModel<SakuraBoatEntity> {
     ...
     */
    public void setRotationAngles(SakuraBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    protected void func_228244_a_(SakuraBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
