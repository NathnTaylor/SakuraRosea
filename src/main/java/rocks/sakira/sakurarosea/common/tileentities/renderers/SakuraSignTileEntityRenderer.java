...
import rocks.sakira.sakurarosea.common.tileentities.SakuraSignTileEntity;

import java.util.List;

@OnlyIn(Dist.CLIENT)
public class SakuraSignTileEntityRenderer extends TileEntityRenderer<SakuraSignTileEntity> {
    private final SakuraSignTileEntityRenderer.SignModel model = new SakuraSignTileEntityRenderer.SignModel();

    public SakuraSignTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    public static RenderMaterial getMaterial(Block blockIn) {
        return Materials.SAKURA_SIGN_MATERIAL;
    }

    public void render(SakuraSignTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        RenderMaterial material = getMaterial(blockstate.getBlock());
