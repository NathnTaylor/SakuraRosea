...
public class SakuraChestTileEntityRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<T> {
    ...
    public SakuraChestTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
