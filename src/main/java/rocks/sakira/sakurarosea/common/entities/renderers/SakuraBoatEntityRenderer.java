package rocks.sakira.sakurarosea.common.entities.renderers;
...
import rocks.sakira.sakurarosea.common.entities.SakuraBoatEntity;
import rocks.sakira.sakurarosea.common.entities.models.SakuraBoatModel;

public class SakuraBoatEntityRenderer extends EntityRenderer<SakuraBoatEntity> {
    ...
    protected final SakuraBoatModel modelBoat = new SakuraBoatModel();

    public SakuraBoatEntityRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.8F;
    }

    public void render(SakuraBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
    ...
    public ResourceLocation getEntityTexture(SakuraBoatEntity entity) {
        return new ResourceLocation(Constants.MOD_ID, "textures/entity/boat/sakura.png");
    }
}
